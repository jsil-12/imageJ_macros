...
function count_cells(fname,output,threshold_path,threshold,autolocal){
...
function main(batchmode){
	...
	print("accessed main");
	//InputDir, ourputDir
	//inputDir = "E:/lab_files/imageJ_macro_working_directory/Gfap_Iba1_ki67/GFAP_Iba1_ki67_batch_microglia_astrocyte_7D/";

	inputDir = "E:/lab_files/imageJ_macro_working_directory/Gfap_S100b_Nestin/input_s100b_retiled_test/";
	outputDir = "E:/lab_files/imageJ_macro_working_directory/Gfap_Iba1_ki67/GFAP_Iba1_ki67_output/output_whole/microglia/cell_counts/";
	threshold_path = "None";  //if "None", the algo autothresholds..
	subtract = true;
	threshold="Default";
	autolocal=true;
	...
	for(f=0;f < filelist.length; f++){
		...
		count_cells(fname,outputDir,threshold_path,threshold,autolocal);
		stop;
